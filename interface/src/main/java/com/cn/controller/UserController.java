...
public class UserController {
    ...
    public Result<?> deleteEssay(@AuthenticationPrincipal User user, @PathVariable("id") Long id) {
    ...
    @PostMapping("/comment")
    public Result<?> commentEssay(@AuthenticationPrincipal User user, @Valid @RequestBody Comment comment) {
    ...
    @GetMapping("/new")
    public Result<?> getMyNews(@AuthenticationPrincipal User user) {
        //TODO
        return null;
    }
    ...
    @PostMapping("/new")
    public Result<?> sendNews(@AuthenticationPrincipal User user, @RequestBody News news) {
        //TODO
        return null;
    }
    ...
    public Result<Page<Essay>> getMyStar(@AuthenticationPrincipal User user, @PathVariable("page") Integer page,
                                         @PathVariable("size") Integer size) {
        return Result.success(essayService.getUserFavesEssay(user.getId(),UserFaves.FAVE_TYPE_LIKE,PageRequest.of(page - 1, size)));
    }

    @Operation(summary = "点赞", description = "用户点赞文章")
    @PostMapping("/star")
    public Result<?> star(@AuthenticationPrincipal User user, @RequestBody Long essayId) {
    ...
    public Result<?> cancelStar(@AuthenticationPrincipal User user, @PathVariable("essayId") Long essayId) {
    ...
    public Result<Page<Essay>> getMyCollect(@AuthenticationPrincipal User user, @PathVariable("page") Integer page,
                                            @PathVariable("size") Integer size) {
        return Result.success(essayService.getUserFavesEssay(user.getId(),UserFaves.FAVE_TYPE_COLLECT,PageRequest.of(page - 1, size)));
    }

    @Operation(summary = "收藏", description = "用户收藏文章")
    @PostMapping("/collect")
    public Result<?> collect(@AuthenticationPrincipal User user, @RequestBody Long essayId) {
    ...
    public Result<?> cancelCollect(@AuthenticationPrincipal User user, @PathVariable("essayId") Long essayId) {
    ...
    public Result<List<Map<String, Object>>> getFollowMe(@AuthenticationPrincipal User user, @PathVariable("page") Integer page,
                                                         @PathVariable("size") Integer size) {
    ...
    public Result<List<Map<String, Object>>> getMyWatches(@AuthenticationPrincipal User user, @PathVariable("page") Integer page,
                                                          @PathVariable("size") Integer size) {
    ...
    @PostMapping("/watch")
    public Result<?> watch(@AuthenticationPrincipal User user, @RequestBody Long userId) {
    ...
    public Result<?> cancelWatch(@AuthenticationPrincipal User user, @PathVariable("userId") Long userId) {
